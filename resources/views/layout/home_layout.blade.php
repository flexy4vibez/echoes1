...
<div class="col-sm-12 top_nav_sticky">
    ...
    <nav class="navbar navbar-expand-md nav_background">
        <div class="container-fluid">
          <a class="navbar-brand" href="{{route('home')}}"><img src="images/favicon.png" alt="echoes logo"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active fw-bold fs-3 text-white" aria-current="page" href="{{route('home')}}">Echoes</a>
              </li>
            </ul>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link active fw-bold" aria-current="page" href="{{route('logout')}}"><p class="text_orange mt-2">Logout</p></a>
                </li>

                <li class="nav-item">
                  <div class="mt-3 fw-bold text_orange">{{auth()->user()->name}}</div>
                </li>
              
                @else
                <li class="nav-item">
                    <a class="nav-link active fw-bold" aria-current="page" href="{{route('sign_in_get')}}"><p class="text_orange mt-2">Sign In</p></a>
                </li>

                <li class="nav-item">
                  <a class="nav-link active fw-bold" aria-current="page" href="{{route('sign_up_get')}}"><p class="text_orange mt-2">Sign Up</p></a>
                </li>
                @endauth
